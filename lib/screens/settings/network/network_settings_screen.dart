...
class NetworkSettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final endpointProvider = Provider.of<EndpointProvider>(context);
      ...
      body: ListView(
        children: [
          ListTile(
            ...
            trailing: Switch(
              value: endpointProvider.enableBuiltinEndpoints,
              onChanged: (value) {
                endpointProvider.setBuiltinEndpoints(value);
              },
            ),
          ),
  ...
  Widget _buildCustomEndpointTile(
    ...
    return ListTile(
      ...
      enabled:
          !endpointProvider
              .enableBuiltinEndpoints, // Disable the tile if built-in endpoints are enabled
      onTap: () {
        if (!endpointProvider.enableBuiltinEndpoints) {
